...
import logo from "./logo-ytrs.PNG";
        ...
        <Toolbar>
          ...
          >
            <div >
              ...
              />
              <Link to={"/"}>
                <img className="" src={logo} alt="logo" style={{ width: "120px" }} />
              </Link>
            </div>
          </IconButton>
      ...
      >
        <div className={classes.toolbar}>
          ...
          <div style={{ paddingRight: "20px", paddingLeft: "12px" }}>
            <Link to={"/"}>
              <img className="mr-2" src={logo} alt="logo" style={{ width: "120px" }} />
